The aim of this repository is to build a model that can predict, from the data characterizing each patient, whether he will have complications during the operation.
